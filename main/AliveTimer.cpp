...
uint32_t AliveTimer::AliveIntervalMS = 0;

void AliveTimer::HandleAliveTimer(System::Layer * /* unused */, void * /* unused */, System::Error /* unused */)
{
    WEAVE_ERROR err;
...
WEAVE_ERROR AliveTimer::Start(uint32_t intervalMS)
{
